...
import card_three_logo from "../assets/images/png/bestnft-img-3.png";
import starIcon3 from "../assets/images/svg/star-3.svg";
import { BestCardIcon } from "../common/Icons";
const TakashiMurakamiCard = () => {
  return (
    <>
      <div className="container xl:max-w-[1140px] 3xl:max-w-[1320px] mx-auto px-5 xl:px-0 pt-20">
        <div className="rounded-[25px] bg-white best_card_border py-[48px] px-5 lg:px-[70px] sm:flex justify-between items-center">
          <div>
            <img src={card_three_logo} alt="bestnft-img-3" className="m-auto" />
          </div>
          <div className="pt-10 sm:pt-0">
            <div className="text-center">
              <img className="m-auto" src={starIcon3} alt="star3" />
              <p className="text-lg ff_josefin text-black opacity-[0.6]">4.0</p>
            </div>
          ...
          <div className="sm:w-[250px] lg:w-[319px]">
            <div className="flex justify-between pt-3">
              ...
              <p className="text-lg ff_josefin text-black">18.9k</p>
            </div>
            <div className="flex justify-between">
              <p className="text-lg ff_josefin opacity-[0.6] text-black">
                Owners
              </p>
              <p className="text-lg ff_josefin text-black">8.4k</p>
            </div>
            <div className="flex justify-between">
              <p className="text-lg ff_josefin opacity-[0.6] text-black">
                Floor price
              ...
              <div className="flex justify-center items-center">
                <BestCardIcon />
                <p className="text-lg ff_josefin text-black pl-[10px]">12.5</p>
              </div>
            </div>
            <div className="flex justify-between">
              <p className="text-lg ff_josefin opacity-[0.6] text-black">
...
export default TakashiMurakamiCard