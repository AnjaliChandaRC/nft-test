  ...
  return (
    <>
      ...
      <div className="text-center mt-[-50px] sm:mt-[-100px]">
        <img src={heroLogo} alt="hero-logo" className="w-[35%] sm:w-[15%] m-auto" />
        <button className="text-[#27A099] text-md font-semibold ff_josefin h-[36.95px] px-[20px] border-[1px] border-solid border-[#27A099] rounded-[25px] mt-4">
          Learn more
        </button>
      </div>
    </>
